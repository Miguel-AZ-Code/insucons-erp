                    ...
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="float-right">
                                <a href="{{ route('admin.proveedores.create') }}" class="btn btn-primary btn-sm float-right"
                                    data-placement="left">
                                    {{ __('Create New') }}
                                </a>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('admin.proveedores.destroy', $proveedore->id) }}"
                                                    method="POST">
                                                    <a width="10px" class="btn btn-sm btn-primary "
                                                        href="{{ route('admin.proveedores.show', $proveedore->id) }}"><i
                                                            class="fa fa-fw fa-eye"></i> Show</a>
                                                    <a width="10px"class="btn btn-sm btn-success"
